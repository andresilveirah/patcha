...
describe PatchesController do
  ...
  describe "GET index" do
    it "assigns all patches as @patches" do
      ...
      assigns(:patches).should eq([patch])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new patch as @patch" do
      ...
      assigns(:patch).should be_a_new(Patch)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created patch as @patch" do
        post :create, {:patch => valid_attributes}, valid_session
        assigns(:patch).should be_a(Patch)
        assigns(:patch).should be_persisted
      end

      it "redirects to the created patch" do
        post :create, {:patch => valid_attributes}, valid_session
        response.should redirect_to(Patch.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved patch as @patch" do
        ...
        Patch.any_instance.stub(:save).and_return(false)
        post :create, {:patch => { "name" => "invalid value" }}, valid_session
        assigns(:patch).should be_a_new(Patch)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patch" do
        patch = Patch.create! valid_attributes
        # Assuming there are no other patches in the database, this
        # specifies that the Patch created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Patch.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => patch.to_param, :patch => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the patch" do
        patch = Patch.create! valid_attributes
        put :update, {:id => patch.to_param, :patch => valid_attributes}, valid_session
        response.should redirect_to(patch)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the patch as @patch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Patch.any_instance.stub(:save).and_return(false)
        put :update, {:id => patch.to_param, :patch => { "name" => "invalid value" }}, valid_session
        assigns(:patch).should eq(patch)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the patches list" do
      patch = Patch.create! valid_attributes
      delete :destroy, {:id => patch.to_param}, valid_session
      response.should redirect_to(patches_url)
    end
  end
